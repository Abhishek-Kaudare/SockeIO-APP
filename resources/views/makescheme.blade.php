...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/bower_components/bootstrap/css/bootstrap.min.css') }}">

    <link rel="stylesheet" href="{{ URL::to('admindek/files/assets/pages/waves/css/waves.min.css') }}" type="text/css" media="all">

    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/assets/icon/feather/css/feather.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/assets/css/font-awesome-n.min.css') }}">

    <link rel="stylesheet" href="{{ URL::to('admindek/files/bower_components/chartist/css/chartist.css') }}" type="text/css" media="all">

    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/bower_components/jquery.steps/css/jquery.steps.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/assets/css/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/assets/css/pages.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('admindek/files/assets/css/widget.css') }}">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        <a href="index.html">
                            <img class="img-fluid" src="{{ URL::to('admindek/files/assets/images/logo.png') }}" alt="Theme-Logo" />
                        </a>
            ...
            <i class="feather icon-search input-group-text"></i>
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{ URL::to('admindek/files/assets/images/avatar-4.jpg') }}" class="img-radius" alt="User-Profile-Image">
                                        <span>John Doe</span>
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online" data-username="Josephin Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-3.jpg') }}" alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online" data-username="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-2.jpg') }}" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online" data-username="Alice">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="4" data-status="offline" data-username="Alia">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ URL::to('admindek/files/assets/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                ...
                <div class="main-friend-chat">
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="{{ URL::to('admindek/files/assets/images/avatar-2.jpg') }}" alt="Generic placeholder image">
                        </a>
                                                                ...
                                                                <form class="wizard-form" id="basic-forms" action="#">
                                                                    ...
                                                                    <fieldset>
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input id="userName-2a" name="title" type="text" class=" form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
                                                                                <label for="email-2" class="block">Ministry</label>
                                                                            </div>
                                                                            <div class="col-sm-12">
                                                                                <input id="email-2a" name="ministry" type="text" class=" form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
                                                                                <label for="password-2" class="block">Description</label>
                                                                            </div>
                                                                            <div class="col-sm-8 col-lg-10">
                                                                                <textarea id="password-2a" name="description" class="form-control"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
                                                                                <label for="confirm-2" class="block">Start date</label>
                                                                            </div>
                                                                            <div class="col-sm-12">
                                                                                <input id="confirm-2a" name="start_date" type="date" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
                                                                                <label for="confirm-2" class="block">End date</label>
                                                                            </div>
                                                                            <div class="col-sm-12">
                                                                                <input id="confirm-2a" name="end_date" type="date" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                    </fieldset>
                                                                    <h3> Scheme Criteria </h3>
                                                                    <fieldset>
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-12">
...
<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/jquery/js/jquery.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/jquery-ui/js/jquery-ui.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/popper.js/js/popper.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/bootstrap/js/bootstrap.min.js') }}"></script>

<script src="{{ URL::to('admindek/files/assets/pages/waves/js/waves.min.js') }}"></script>

<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/jquery-slimscroll/js/jquery.slimscroll.js') }}"></script>

<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/modernizr/js/modernizr.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/bower_components/modernizr/js/css-scrollbars.js') }}"></script>

<script src="{{ URL::to('admindek/files/bower_components/jquery.cookie/js/jquery.cookie.js') }}"></script>
<script src="{{ URL::to('admindek/files/bower_components/jquery.steps/js/jquery.steps.js') }}"></script>
<script src="{{ URL::to('admindek/files/bower_components/jquery-validation/js/jquery.validate.js') }}"></script>

<script type="text/javascript" src="{{ URL::to('admindek/files/assets/pages/form-validation/validate.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/forms-wizard-validation/form-wizard.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/chart/float/jquery.flot.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/chart/float/jquery.flot.categories.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/chart/float/curvedLines.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/chart/float/jquery.flot.tooltip.min.js') }}"></script>

<script src="{{ URL::to('admindek/files/bower_components/chartist/js/chartist.js') }}"></script>

<script src="{{ URL::to('admindek/files/assets/pages/widget/amchart/amcharts.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/widget/amchart/serial.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/pages/widget/amchart/light.js') }}"></script>

<script src="{{ URL::to('admindek/files/assets/js/pcoded.min.js') }}"></script>
<script src="{{ URL::to('admindek/files/assets/js/vertical/vertical-layout.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/assets/pages/dashboard/custom-dashboard.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('admindek/files/assets/js/script.min.js') }}"></script>
</body>
</html>